...
public abstract class LinkedList<T> implements ListADT<T>, Iterable<T>
{
     ...
     */
    public T removeFirst() throws Error
    {
        if (isEmpty())
            throw new Error("LinkedList");
     ...
     */
    public T remove(T targetElement) throws Error
    {
        if (isEmpty())
            throw new Error("LinkedList");
